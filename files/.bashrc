...
export EDITOR="vim"
export BW_SESSION="WQlU141/G297z/sZrxOe9f2kE0sobOw5iZY9pZWbFNPmQPvANAzIir5CnthQlkSOjjFri3guIt2wtcn+PTgojQ=="
...
alias goodnight="echo goodbye && sleep 3 && sudo shutdown -h now" 
alias zucc="echo Zuccccing && sleep 3 && sudo restart -h now"
alias tor="cd ~/Downloads/tor-browser_en-US && ./start-tor-browser.desktop" 
# Fix dotnet whitespace issues
alias dotnet-fix="find . -name '*.cs' -exec sed -i 's/\s*$//g' {} +"
# Delete all local branches not on remote
git-clean() { git fetch -p && for branch in `git branch -vv | grep ': gone]' | awk '{print $1}'`; do git branch -D $branch; done } 
